...
export const pl: TranslationMap = {
  ...
  dashboard: {
    ...
    widget: {
      ...
      errorTitle: "Nie udało się wyrenderować tego widżetu",
      customPlaceholder: "Widżet niestandardowy — dostępny po udostępnieniu hosta widżetów.",
      markdownEmpty: "Brak treści.",
      unknownKind: "Nieznany typ widżetu: {kind}",
      editTitlePrompt: "Tytuł widżetu",
      moveToTabPrompt: "Do której karty obszaru roboczego przenieść? Wprowadź jego slug.",
      menu: {
