...
export const fa: TranslationMap = {
  ...
  dashboard: {
    ...
    widget: {
      ...
      errorTitle: "رندر این ویجت شکست خورد",
      customPlaceholder: "ویجت سفارشی — پس از عرضه میزبان ویجت در دسترس خواهد بود.",
      markdownEmpty: "هنوز محتوایی وجود ندارد.",
      unknownKind: "نوع ویجت ناشناخته: {kind}",
      editTitlePrompt: "عنوان ابزارک",
      moveToTabPrompt: "به کدام زبانه‌ی فضای کاری منتقل شود؟ slug آن را وارد کنید.",
      menu: {
