...
export const en: TranslationMap = {
  ...
  workspaces: {
    ...
    history: {
      ...
      subtitle: "Review recent changes, compare against now, and restore a snapshot.",
      empty: "No history yet — changes appear here after your first edit.",
      emptyDetail: "Select a version to preview it.",
      version: "Version {version}",
      latest: "Latest change",
      previewTitle: "Snapshot",
      previewEmpty: "This tab had no widgets at this point.",
      diffTitle: "Structural changes since this version",
      diffEmpty: "Nothing changed since this version.",
      restore: "Restore snapshot",
      restoreConfirm: "Restore this exact snapshot as a new version?",
      ...
      kind: {
        ...
        "widget-retitled": "Retitled",
        "tab-added": "Tab added",
        "tab-removed": "Tab removed",
        "tab-retitled": "Tab retitled",
      },
    },
    onboarding: {
    ...
    widget: {
      ...
      blame: {
        createdBy: "Created by {creator}; exact version unknown",
        createdByVersion: "Created by {creator} · v{version}",
        createdByRange: "Created by {creator} after v{afterVersion} and by v{byVersion}",
        logbookLink: "View in logbook",
      },
