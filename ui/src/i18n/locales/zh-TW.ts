...
export const zh_TW: TranslationMap = {
  ...
  dashboard: {
    ...
    error: {
      title: "無法載入您的工作區",
      subtitle: "載入您的工作區時發生錯誤。請嘗試重新整理。",
      detailSummary: "顯示詳細資訊",
    },
    header: {
      subtitle: "排列此工作區的小工具和分頁。",
    },
    onboarding: {
      title: "建立您的第一個工作區分頁",
      primary: "要求您的代理程式建立分頁。",
      secondary: "或透過指令列建立：",
    },
    empty: {
      onboardingTitle: "尚無工作區",
      onboardingSubtitle: "指示您的代理建立儀表板，或從命令列建立一個。",
      onboardingCommand: "openclaw dashboard tabs create main --title Main",
      tabTitle: "此工作區是空的",
      tabSubtitle: "指示您的代理新增小工具，或自行新增。",
      noVisibleTabs: "所有工作區分頁皆已隱藏。請從隱藏選單還原其中一個。",
    },
    widget: {
      collapse: "摺疊小工具",
      expand: "展開小工具",
      moveHandle: "移動小工具",
      resizeHandle: "調整小工具大小",
      menuLabel: "小工具選項",
      provenanceChip: "AI",
      provenanceTooltip: "由 {agent} 建立",
      errorTitle: "此小工具無法載入",
      errorHumane: "此小工具在轉譯時發生問題。",
      errorDetailSummary: "顯示詳細資訊",
      customPlaceholder: "自訂小工具 — 即將推出。",
      customLoading: "正在載入自訂小工具……",
      approval: {
        title: "等待核准的自訂小工具",
        byAgent: "由 {agent} 建立",
        byUnknown: "由未知的代理程式建立",
        approve: "核准",
        reject: "拒絕",
        unavailable: "此自訂小工具無法使用。請要求您的代理程式重新建立，或將其移除。",
      },
      markdownEmpty: "尚無內容。",
      unknownKind: "未知的小工具類型：{kind}",
      editTitleTitle: "編輯小工具標題",
