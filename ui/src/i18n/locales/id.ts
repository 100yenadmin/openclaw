...
export const id: TranslationMap = {
  ...
  dashboard: {
    ...
    widget: {
      ...
      errorTitle: "Widget ini gagal dirender",
      customPlaceholder: "Widget khusus — tersedia setelah host widget dirilis.",
      ...
      editTitlePrompt: "Judul widget",
      moveToTabPrompt: "Pindahkan ke tab ruang kerja mana? Masukkan slug.",
      menu: {
