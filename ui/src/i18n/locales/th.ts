...
export const th: TranslationMap = {
  ...
  dashboard: {
    ...
    widget: {
      ...
      errorTitle: "ไม่สามารถแสดงผลวิดเจ็ตนี้ได้",
      customPlaceholder: "วิดเจ็ตที่กำหนดเอง — จะพร้อมใช้งานเมื่อ widget host เปิดตัว",
      ...
      editTitlePrompt: "ชื่อวิดเจ็ต",
      moveToTabPrompt: "ย้ายไปที่แท็บพื้นที่ทำงานใด? ป้อน slug ของแท็บนั้น",
      menu: {
        editTitle: "แก้ไขชื่อ",
